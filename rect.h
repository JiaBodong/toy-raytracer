...
bool xy_rect::hit(const ray& r, float t0, float t1, hit_record& rec) const {
    ...
    rec.set_face_normal(r,vec3(0,0,1)); // Modified: Normal vector points in the negative z direction
    return true;
}
...
bool xz_rect::hit(const ray& r, float t0, float t1, hit_record& rec) const {
    ...
    rec.mat_ptr = mp;
    rec.p = r.point_at_parameter(rec.t);
    rec.set_face_normal(r,vec3(0,1,0)); // Modified: Normal vector points in the negative x direction
    return true;
}
...
bool yz_rect::hit(const ray& r, float t0, float t1, hit_record& rec) const {
    ...
    rec.mat_ptr = mp;
    rec.p = r.point_at_parameter(rec.t);
    rec.set_face_normal(r,vec3(1,0,0)); // Modified: Normal vector points in the negative y direction
    return true;
}
